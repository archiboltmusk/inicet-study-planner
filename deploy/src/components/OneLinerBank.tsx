...
const FALLBACK_ONELINERS: OneLiner[] = [
  ...
  { id: "fb-3", subject: "PSM",           topic: "Vital Statistics", fact: "India IMR (SRS 2020-21): 35/1000 live births. MMR (SRS 2018-20): 97/100,000 live births. TFR: 2.0 (below replacement level of 2.1).", mnemonic: null, category: "value",     batch_date: "2024-01-01" },
